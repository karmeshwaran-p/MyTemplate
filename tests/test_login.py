...
class TestLogin:
    def test_login(self, testapp):
        ...
        rv = testapp.post(
            "/login",
            data=dict(email="admin@example.com", password="supersafepassword"),
    ...
    def test_login_bad_email(self, testapp):
        ...
        rv = testapp.post(
            "/login", data=dict(email="admin", password=""), follow_redirects=True
        )
    ...
    def test_login_bad_password(self, testapp):
        ...
        rv = testapp.post(
            "/login",
            data=dict(email="admin@example.com", password="notsafepassword"),
            follow_redirects=True,
        )
