...
class GDPRExport:
    ...
    def send_pii_export(self):
        ...
        attachment = Attachment(
            filename="user_export.json", content_type="application/json", data=json_str
        )
        mailer = NotificationMailer(
            self._requesting_user.email,
            "appname User Data Export",
            "Your requested export is attached below",
    ...
    def export_user_pii_json(self):
        ...
        models_to_export = [
            getattr(self.user, accessor) for accessor in related_models_accessors
        ]
