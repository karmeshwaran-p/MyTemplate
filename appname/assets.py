...
store_css = Bundle("css/store.css", filters="cssmin", output="public/css/store.css")

landing_css = Bundle(
    "css/landing.css", filters="cssmin", output="public/css/landing.css"
)
...
tabler_plugins_css = Bundle(
    "tabler/js/plugins/charts-c3/plugin.css", output="public/css/tabler-plugins.css"
)
